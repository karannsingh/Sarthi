                ...
                <div class="row mb-4">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <small id="link_warning" class="text-danger" style="display:none;">Enter a valid PolicyBazaar link.</small>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
  ...
  <script type="text/javascript">
    ...
    // Check Vehicle Number in the database in real-time
      ...
      $("#link").on("input", function() {
        var link = $(this).val();
        var validPattern1 = "https://pbpci.policybazaar.com/v2/quotes?";
        var validPattern2 = "https://pbpci.policybazaar.com/v2/proposal?";

        if (link.startsWith(validPattern1) || link.startsWith(validPattern2)) {
          $("#link_warning").hide();
        } else {
          $("#link_warning").show();
        }
